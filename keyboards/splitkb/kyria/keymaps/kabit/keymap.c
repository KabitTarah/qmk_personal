...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 // |----------+---------+---------+---------+---------+---------+---------------------.  ,---------------------+---------+---------+---------+---------+---------+----------|
      TT_LEFT,   _____COLEMAK_ROW_3L_____                       ,  KC_LCTL,   KC_LALT,      KC_RALT,   KC_RCTL,   _____COLEMAK_ROW_3R_____                       ,  TT_RGHT,
 // `------------------------------+---------+---------+---------+----------+----------|  |----------+----------+---------+---------+---------+------------------------------'
                                     XXXXXXX,  KC_TAB ,  KC_BSPC,  KC_LSFT,   KC_ESC ,      KC_LGUI,   KC_SPC,    KC_ENT ,  KC_GRV ,  XXXXXXX
 //                                `---------+---------+---------+----------+----------|  |----------+----------+---------+---------+---------'
    ),
